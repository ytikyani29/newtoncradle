...
function setup() {
  ...
  var ball_options = {
    ...
    bob1 = Bodies.circle(300,150,20,ball_options);
    World.add(world,bob1);
    bob2 = Bodies.circle(350,150,20,ball_options);
    World.add(world,bob2);
    bob3 = Bodies.circle(400,150,20,ball_options);
    World.add(world,bob3);
    bob4 = Bodies.circle(450,150,20,ball_options);
    World.add(world,bob4);
    bob5 = Bodies.circle(500,150,20,ball_options);
...
function keyPressed(){
  if(keyDown("UP_ARROW")){
    Matter.Body.applyForce(bob1,{x:0,y:0},{x:0,y:10})
  }
}